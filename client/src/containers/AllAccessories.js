...
class AllAccessories extends React.Component {
                ...
                return (
                    <div key={product._id} className="col-lg-4 pb-5">
                        <div className="BoxShadow">
                            <img src={product.img} alt="Accessories" className="img-thumbnail img-fluid mt-5" />
    ...
    render() {
        return (
            <section className='container text-center img all-product-info' >
                <p>ACCESSORY PRODUCTS</p>
                <div className="row">
                    {this.state.products.length > 0 && this.renderAllAccessories()}
                </div>
            </section>
        )
    }
